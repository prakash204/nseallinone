...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['wireless', 'socket', 'udp', 'tcp', 'routing', 'realtime', 'traffic-control', 'energy', 'tutorial', 'ipv6', 'naming', 'matrix-topology', 'stats', 'error-model', 'udp-client-server']
...
NS3_EXECUTABLE_PATH = ['/home/prakash-ubuntu/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/prakash-ubuntu/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
cfg_files = ['/home/prakash-ubuntu/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/prakash-ubuntu/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
